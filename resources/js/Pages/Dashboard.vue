...
<template>
    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            >
                <span class="font-bold">IMPORTANTE:</span> Tu perfil aún no se ha verificado, si no encuentras el mensaje de
                verificación en tu bandeja, pulsa
                <Link :href="route('verification.notice')" class="font-bold underline hover:text-skyblue-vlight transition-all ">AQUÍ</Link>
            </p>
        </ContentBox>

...
Route::middleware([CheckAdmin::class, 'auth', 'verified'])->group(function () {
    ...
    Route::get('/admin_mostrar_reservas/{id}', [ReservaController::class, 'showAdmin'])->name('admin.showReservas');
    Route::post('/admin_eliminar_reserva', [ReservaController::class, 'delAdmin'])->name('admin.delReservas');
    Route::get('/admin_modificar_reserva/{id_dia}/{id_reserva}', [ReservaController::class, 'modAdmin'])->name('admin.modReservas');
    Route::post('/admin_modificar_reserva', [ReservaController::class, 'modHourAdmin'])->name('admin.modHourReservas');
    Route::get('/admin_lista_pasadas', [ReservaController::class, 'listPastAdmin'])->name('admin.listPastReservas');
    Route::get('/admin_mostrar_reservas_pasadas/{id}', [ReservaController::class, 'showPastAdmin'])->name('admin.showPastReservas');
